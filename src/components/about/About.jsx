            ...
            <div className="container about__container">
                ...
                <div className="about__content">
                    ...
                    <p>
                        ...
                        As a Cloud DevOps Engineer and Automation Architect, I am proficient in Linux (ARM & x86 architecture), Windows, Python, and Shell/Bash scripting. I create and maintain Debian (Ubuntu) and RHEL (Fedora, CentOS) based VMs & servers, develop and maintain CI/CD pipelines, and leverage Infrastructure as Code (IaC) with Terraform and GitOps. I am experienced in containerization with Docker and Kubernetes and have expertise in configuration management tools like Ansible on cloud platforms as well as on-premises infrastructure. I excel in using Java, Selenium, Appium, BDD with Cucumber and Gherkin, and have knowledge in building CI/CD pipelines using Jenkins, AWS CodeBuild / CodePipeline, GitHub Actions. I am well-versed in Agile and Waterfall SDLC methodologies.<br></br><br></br>
