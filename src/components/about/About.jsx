            ...
            <div className="container about__container">
                ...
                <div className="about__content">
                    ...
                    <p>
                        ...
                        In Software Development, I am proficient in JavaScript, Node.js, ReactJS, JSX, jQuery, APIs, HTML, CSS, and Bootstrap.<br></br>

                        I have hands-on experience with AWS and Microsoft Azure cloud platforms, as well as various operating systems including Windows, MacOS, and Linux distributions.<br></br><br></br>

                        In Automation Architecture, I excel in automation testing using Java, Selenium, Appium, BDD with Cucumber and Gherkin, and have knowledge in building CI/CD pipelines. I am well-versed in Agile and Waterfall SDLC methodologies.<br></br><br></br>

                        My expertise extends to Data Science, ML, and AI Algorithms, where I leverage Python, Scikit-learn, TensorFlow, NumPy, Pandas, Matplotlib, Seaborn, and various machine learning algorithms such as Decision Trees, KNNs, Logistic Regression, Confusion Matrix, SVM, Neural Networks, and CNNs.<br></br><br></br>
